      ...
      <div className="w-full max-w-4xl bg-white shadow-md rounded-lg p-6">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            ...
            <p><span className="font-semibold">Date of Birth:</span> {user.profile ? new Date(user.profile.dateOfBirth).toLocaleDateString() : ''}</p>
          ...
          <div>
            ...
            <p><span className="font-semibold">Manager:</span> {user.manager ? `${user.manager.profile.firstName} ${user.manager.profile.lastName}` : 'N/A'}</p>
          </div>
        </div>
        <div className="mt-6">
